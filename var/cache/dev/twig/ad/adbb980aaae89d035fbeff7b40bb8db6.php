...
class __TwigTemplate_1c3c200f1f0c59de184b4cf73994a1df extends Template
{
    private $source;
    private $macros = [];
...
<tr>
  ...
  <td><a href=\"";
                // line 58
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("client_delete", ["clientId" => twig_get_attribute($this->env, $this->source, $context["client"], "id", [], "any", false, false, false, 58)]), "html", null, true);
  ...
  <td><a href=\"";
                // line 59
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("client_update", ["clientId" => twig_get_attribute($this->env, $this->source, $context["client"], "id", [], "any", false, false, false, 59)]), "html", null, true);
...
<tr>
  <td class=\"border-bottom-0\"><a href=\"";
        // line 88
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("client_create_for_bailleur");
...
<tr>
  <td class=\"border-bottom-0\"><a href=\"{{path('client_create_for_bailleur')}}\" role=\"button\" class=\"btn btn-success text-light\">Ajouter un client</a></td>
