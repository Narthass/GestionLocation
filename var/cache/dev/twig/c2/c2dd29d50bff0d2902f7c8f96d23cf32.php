...
class __TwigTemplate_fceefaa59a16f14ffef3ed3a488113be extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user  %}
        <div class=\"mb-3\">
            Vous êtes actuellement connecté en tant que {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
        </div>
    {% endif %}
